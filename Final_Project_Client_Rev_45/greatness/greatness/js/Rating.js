...
$(document).ready(function () {
    if (
        ...
        urlRating = "https://localhost:7006/api/Rating";
    } else {
        urlRating = "https://proj.ruppin.ac.il/cgroup44/prod/api/Rating";
    }
...
function SendRating() {//שליחת פרטי הדירוג לשרת
    ...
    ajaxCall("POST", urlRating, JSON.stringify(Rating), PostRateSCB, PostRateECB);
