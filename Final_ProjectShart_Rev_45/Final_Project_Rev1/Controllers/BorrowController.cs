...
namespace Final_Project_Rev1.Controllers
{
    ...
    public class BorrowController : ControllerBase
    {
        ...
        {
            List<object> listMatch = new List<object>();
            Borrow b = new Borrow();
        ...
        [HttpGet("GetBorrowsForGeneral")] //מחזיר את כל ההשאלות הפנויות לדף הכללי
        public List<object> GetBorrowsForGeneral(int idBuilding, string email) //שליפת כל המאצים של ההשאלה הנתונה
        {
            Borrow b = new Borrow();
            return b.GetBorrowForGeneral(idBuilding, email);
        }
        //eden
        ...
        // GET api/<BorrowController>/5
        [HttpGet("User/{email}")]
        public List<object> GetBorrows(string email)//שליפת ההשאלות של המשתמש לפי המייל
        {
            Borrow b = new Borrow();
